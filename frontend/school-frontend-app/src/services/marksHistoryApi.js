...
export const getResultHistory = async (resultId, resultModel = 'OLevelResult') => {
  try {
    ...
    const response = await api.get(`/api/marks-history/result/${resultId}?resultModel=${resultModel}`);
...
export const getStudentHistory = async (studentId) => {
  try {
    ...
    const response = await api.get(`/api/marks-history/student/${studentId}`);
    return response.data;
  } catch (error) {
...
export const getSubjectHistory = async (subjectId) => {
  try {
    ...
    const response = await api.get(`/api/marks-history/subject/${subjectId}`);
    return response.data;
  } catch (error) {
...
export const getExamHistory = async (examId) => {
  try {
    ...
    const response = await api.get(`/api/marks-history/exam/${examId}`);
    return response.data;
  } catch (error) {
...
export const revertToVersion = async (historyId, reason = '') => {
  try {
    ...
    const response = await api.post(`/api/marks-history/revert/${historyId}`, { reason });
    return response.data;
  } catch (error) {
